...
| `/pinterest-login` | Auto via `PINTEREST_USERNAME` / `PINTEREST_PASSWORD`. Pauses for any CAPTCHA challenge. | ✅ Live-tested 2026-05-04 (manual pre-auth via Google sign-in; state saved) |
